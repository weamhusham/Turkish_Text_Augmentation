...
model_name = "intfloat_multilingual-e5-large-instruct"

os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'  # Suppress TensorFlow logs

# Paths
processed_path = r"D:\Important\WeamCollectiveLearning\Project\ProcessedDatasets"
augmented_path = r"D:\Important\WeamCollectiveLearning\Project\AugmentedTestDatasets"
output_path = r"D:\Important\WeamCollectiveLearning\Project\Embeddings"
model_path = r"D:\Important\WeamCollectiveLearning\Project\Models\intfloat_multilingual-e5-large-instruct"
...
def map_labels_to_numeric(datasets, group_key):
    """
    Map labels to numeric values for all datasets in a group.
    ...
    for file_name, _, label_column, path in datasets:
        ...
        try:
            ...
            log_timestamp(f"Error reading {file_name}: {e}")
    ...
    for file_name, _, label_column, path in datasets:
        ...
        try:
            ...
            log_timestamp(f"Error processing {file_name}: {e}")
