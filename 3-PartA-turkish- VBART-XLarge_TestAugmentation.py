...
for dataset_name, dataset_path in datasets.items():
    ...
    # Save to CSV files
    output_file_3 = os.path.join(output_dir, f"{dataset_name}_VBART-XLarge-augmented_3_records.csv")
    output_file_5 = os.path.join(output_dir, f"{dataset_name}_VBART-XLarge-augmented_5_records.csv")
    try:
